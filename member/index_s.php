			...
			<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
			    <div class="container">
			      ...
			      <div class="collapse navbar-collapse" id="ftco-nav">
			        <ul class="navbar-nav ml-auto">
			            ...
			            <li class="nav-item active"><a href="index_s.php" class="nav-link">Video</a></li>
			            <li class="nav-item"><a href="artikel/index.php" class="nav-link">Artikel</a></li>
			            <li class="nav-item"><a href="artikel/soal.php" class="nav-link">Quiz</a></li>
			            <li class="nav-item"><a href="artikel/profil.php" class="nav-link">Profil</a></li>
			            <li class="nav-item"><a href="artikel/profil_pre.php" class="nav-link">Reminder</a></li>
				...
				<section id="banner" data-video="images/banner">
					<div class="inner">
						<header>
							<h1>Waching It</h1>
							<p>Always Enjoy With Our Video<br />
